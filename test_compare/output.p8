__lua__
?"hello ᶜ7there♥ら"
t(stat(band()))t()a=0n=0n=0print"this is included"?"#[disable[[this for now/ever]]]"
local n={1,2,3}print(#n)print(#[[#include notaninclude
]])local n="preserved_key"local d={preserved_key=123}?d[n]
...
local n="a"local d={a=123}?d[n]
local n=split"o,c,f,123"local d={o=123,c=234,f=345}?d[n[2]]
...
l=setmetatable({preserved3=3},f)?l["preserved3"]
