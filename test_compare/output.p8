...
local e=({})[1],(function()end)()local l,n,o,e,f=sin(1,2),cos((cos())),(cos((cos()))),{d=ord,a=pal}local e=ord"123",pal{1,2},e:d("ord"),e:a({1,2}),sin(1)local i={ord"1",[2]=3,o=4,(ord"1")}e+=1l,n=sin(1,2),cos((cos()))o,f=(cos((cos())))function k()return 1,2,ord"1",(ord"1")end if 1==2do elseif 1==2do else end while 1==2do end repeat until 1==1for e in(all{})do end print("test"..@16 .."str")if(true)?"sh1"
if(true)?"sh2"
