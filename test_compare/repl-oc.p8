...
return t,n+1end function Y(t,n,l,r)if e(t,n)=="["then n+=1local o=n while(e(t,n)=="=")n+=1
...
return nil,n end function ゛(l,c)local n,s,i=1,1local o,h,b,p,u={},{},{},{}local function d(n,e)if(c)゜(n,i)
...
add(o,tonum(r))elseif B(t)then while B(e(l,n))do n+=1end add(o,sub(l,i,n-1))elseif t=="'"or t=='"'then r,n=き(l,n+1,t,d)add(o,{t=r})elseif t=="["and f(e(l,n+1),"=[")then r,n=Y(l,n,d,true)add(o,{t=r})else n+=1local e,r,u=unpack(split(sub(l,n,n+2),""))if e==t and r==t and f(t,".>")then n+=2if(u=="="and f(t,">"))n+=1
...
end end function c(n)return unpack(n,1,n.n)end function く(e)local n={}for t,l in next,e do n[t]=l end return n end local Y=split"and,break,do,else,elseif,end,false,for,function,goto,if,in,local,nil,not,or,repeat,return,then,true,until,while"G={}for n in all(Y)do G[n]=true end local function Y(n)return type(n)=="string"and e(n,#n)=="="end あ=split"end,else,elseif,until"function い(n,j)local o,F,l=゛(n,true)local n,f,s,y,h,Z=1,0,0local t,b local v,d,p,x={}local function i(e)゜(e,l[n-1]or 1)end local function g(n)return function()return n end end local function C(e)local n=d[e]if n then return function(t)return t[n][e]end else n=d._ENV return function(t)return t[n]._ENV[e]end end end local function q()local n=d["..."]if(not n or n~=Z)i"unexpected '...'"
...
end local function A()d=setmetatable({},{__index=d})f+=1end local function B()d=getmetatable(d).__index f-=1end local function m(r,l)local e={}local n=#l for t=1,n-1do e[t]=l[t](r)end if n>0then local t=pack(l[n](r))if t.n~=1then for l=1,t.n do e[n+l-1]=t[l]end n+=t.n-1else e[n]=t[1]end end e.n=n return e end local function k(t)local n={}add(n,(t()))while e","do add(n,(t()))end return n end local function X(r,o,i)local n={}if i then add(n,i)elseif not e")"then while true do add(n,(t()))if(e")")break
...
if(not e";")l","
end return function(e)local t={}for n=1,#r do if n==a then local o,l=r[n](e),pack(d[n](e))for n=1,l.n do t[o+n-1]=l[n]end else t[r[n](e)]=d[n](e)end end return t end end local function E(o,a)local n,p,t if o then if a then A()n=u()d[n]=f t=D(n)else n={u()}while(e".")add(n,u())
if(e":")add(n,u())p=true
...
end end A()for e in all(n)do d[e]=f end if(r)d["..."]=f
local e,i,d=v,h,Z v,h,Z={},s+1,f local u=b()for n in all(v)do n()end v,h,Z=e,i,d l"end"B()return function(e)if(a)add(e,{})
local l=く(e)local i=#l local f=function(...)local t=pack(...)local e=l if#e~=i then local n={}for t=0,i do n[t]=e[t]end e=n end local l={}for e=1,#n do l[n[e]]=t[e]end if(r)l["..."]=pack(unpack(t,#n+1,t.n))
...
if(e=="...")return q()
if(e=="\\")n=u()return function()return け(n)end,true,function()return こ(n)end
...
l"("return X(e,r)end end local l=D(i,d,e,t)if(not l)n-=1
...
return n end local function q()local n=k(Z)l"="local e=k(t)if#n==1and#e==1then return function(t)local l,r=n[1](t)l[r]=e[1](t)end else return function(t)local l,r={},{}for e=1,#n do local o,i=n[e](t)add(l,o)add(r,i)end local o=m(t,e)for e=#n,1,-1do l[e][r[e]]=o[e]end end end end local function G(e,l)local r=o[n]n+=1local o=sub(r,1,-2)local n=D(o,0,e,function()return t()end)if(not n)i"invalid compound assignment"
return function(e)local t,r=l(e)t[r]=n(e)end end local function H()if e"function"then return E(true,true)else local n=k(u)local l=e"="and k(t)or{}A()for e=1,#n do d[n[e]]=f end if#n==1and#l==1then return function(e)add(e,{[n[1]]=l[1](e)})end else return function(e)local t={}local r=m(e,l)for e=1,#n do t[n[e]]=r[e]end add(e,t)end end end end local function D(e)local t=F[n-1]x=function()return t~=F[n]end if(not e or x())i(n<=#o and"bad shorthand"or nil)
...
return n,e end local function I()local r=o[n]=="("local o=t()local n if e"do"then n=Z()l"end"else D(r)n=Z()x=nil end return function(e)while o(e)do if(stat(1)>=1)w()
local t,l=n(e)if(t)return X(t,l)
end end end local function D()local r=f local o=Z(true)l"until"local l=t()while(f>r)B()
return function(n)repeat if(stat(1)>=1)w()
local e,t=o(n)if(not e)t=l(n)
while(#n>r)deli(n)
if(e)return X(e,t)
until t end end local function J()if o[n+1]=="="then local r=u()l"="local o=t()l","local i=t()local u=e","and t()or g(1)l"do"A()d[r]=f local t=Z()l"end"B()return function(n)for e=o(n),i(n),u(n)do if(stat(1)>=1)w()
add(n,{[r]=e})local e,l=t(n)deli(n)if(e)return X(e,l)
end end else local r=k(u)l"in"local o=k(t)l"do"A()for n in all(r)do d[n]=f end local i=Z()l"end"B()return function(n)local e=m(n,o)while true do local l={}local t={e[1](e[2],e[3])}if(t[1]==nil)break
e[3]=t[1]for n=1,#r do l[r[n]]=t[n]end if(stat(1)>=1)w()
add(n,l)local e,t=i(n)deli(n)if(e)return X(e,t)
...
if o[n]==";"or r(o[n],あ)or x and x()then return function()return pack()end else local r,n,l=t()local n={r}while(e",")add(n,(t()))
if#n==1and l and h then return function(n)local e,t=l(n)if(stat(1)>=1)w()
return function()return e(c(t))end end else return function(e)return m(e,n)end end end end local function A(e)local n=u()l"::"if(p[n]and p[n].e==s)i"label already defined"
...
if r=="?"then local e,l=C"print",k(t)return function(n)e(n)(c(m(n,l)))end end n-=1local f=n local l,d,r=t()if e","or e"="then n=f return q()elseif Y(o[n])then return G(l,d)elseif s<=1and z then return function(e)local n=pack(l(e))if(not(r and n.n==0))add(a,n)
W=n[1]end else if(not r)i"statement has no effect"
return function(n)l(n)end end end b=function(t)p=setmetatable({},{__index=p})p[s]=f s+=1local d=s local i=t and 32767or f local l={}while n<=#o and not r(o[n],あ)and not(x and x())do local n,t=u(l)if(n)add(l,n)
if(t)e";"break
end while(f>i)B()
...
for n in all(v)do n()end return function(n)local t=z and{_ENV=n,_env=n,_=W}or{_ENV=n}local n=e{[0]=t}if(n)return c(n)
end end O,P=10,false local W={["\0"]="000",["ᵉ"]="014",["ᶠ"]="015"}for n,e in pairs(█)do if(not f(n,"'\n"))W[e]=n
end function さ(n)local t=1while t<=#n do local l=e(n,t)local e=W[l]if(e)n=sub(n,1,t-1).."\\"..e..sub(n,t+1)t+=#e
t+=1end return'"'..n..'"'end function し(n)if(type(n)~="string")return false
if(G[n])return false
if(#n==0or g(e(n,1)))return false
for t=1,#n do if(not B(e(n,t)))return false
end return true end function Z(e,t)local n=type(e)if n=="nil"then return"nil"elseif n=="boolean"then return e and"true"or"false"elseif n=="number"then return tostr(e,P)elseif n=="string"then return さ(e)elseif n=="table"and not t then local n="{"local l=0local r=0for t,o in next,e do if(l==O)n=n..",<...>"break
if(l>0)n=n..","
local e=Z(o,1)if t==r+1then n=n..e r=t elseif し(t)then n=n..t.."="..e else n=n.."["..Z(t,1).."]="..e end l+=1end return n.."}"else return"<"..tostr(n)..">"end end function す(n,e)if(e==nil)return n
if(not n)n=""
...
add(a,tostr(n))end function う()poke(24368,1)end function え()return function()if(stat(30))return stat(31)
end end function Q(r,i)local t=1local n,l=0,0if(not r)return t,n,l
while t<=#r do local o=e(r,t)local e=o>="█"if(n>=(e and 31or 32))l+=1n=0
if(i)i(t,o,n,l)
if o=="\n"then l+=1n=0else n+=e and 2or 1end t+=1end return t,n,l end function C(o,l)local n,e=0,0local i,r,t=Q(o,function(t,i,r,o)if(l==t)n,e=r,o
end)if(l>=i)n,e=r,t
if(r>0)t+=1
return n,e,t end function D(i,r,e)local t=1local n=false local o,f,l=Q(i,function(o,f,i,l)if(e==l and r==i and not n)t=o n=true
if((e<l or e==l and r<i)and not n)t=o-1n=true
end)if(not n)t=e>=l and o or o-1
if(f>0)l+=1
return t,l end function R(n,t,l,e)if type(e)=="function"then Q(n,function(n,r,o,i)print(r,t+o*4,l+i*6,e(n))end)else print(n and"⁶rw"..n,t,l,e)end end function せ(n,o,f)local d,t,u,l=゛(n)local t=1R(n,o,f,function(o)while t<=#l and l[t]<o do t+=1end local n if(t<=#l and u[t]<=o)n=d[t]
local t=i[5]if n==false then t=i[6]elseif n==true then t=i[7]elseif type(n)~="string"or r(n,{"nil","true","false"})then t=i[8]elseif G[n]then t=i[9]elseif not B(e(n,1))then t=i[10]elseif ▒[n]then t=i[11]end return t end)end function _draw()local u=peek(24357)local c,p=peek2(24360),peek2(24362)camera()local function e(n)cursor(0,127)for e=1,n do rectfill(0,o*6,127,(o+1)*6-1,0)if o<21then o+=1else print""end end end local function w(n,e)for t=1,n do if(o>e)o-=1
rectfill(0,o*6,127,(o+1)*6-1,0)end end local function m(n,e)for t=0,2do local l=pget(n+t,e+5)pset(n+t,e+5,l==0and i[12]or 0)end end local function f(u)local r=d..n.." "local f,t,n=C(r,#d+l)if n>s then e(n-s)elseif n<s then w(s-n,n)end s=n k=mid(k,0,max(s-21,0))::again::local e=o-s+k if(e+t<0)k+=1goto again
if(e+t>=21)k-=1goto again
local n=e*6rectfill(0,n,127,n+s*6-1,0)if(s>21)rectfill(0,126,127,127,0)
せ(r,0,n)print(d,0,n,i[4])if(v>=10and u~=false and not x)m(f*4,n+t*6)
end local function d(t)e(1)o-=1print("[enter] ('esc' to abort)",0,o*6,i[3])while true do flip()う()for n in え()do if(n=="•")X=true b=""a={}return false
if(n=="\r"or n=="\n")h+=t return true
end end end::again::local r,t if a or b then r,t=D(b,0,h)if t-h<=20and a then b,a=す(b,a)r,t=D(b,0,h)if(#a==0and not x)a=nil
end end if(not x)camera()
if(h==0and not x)f(not b)
if b then local u=sub(b,r)local r=min(t-h,20)e(r)R(u,0,(o-r)*6,i[1])if r<t-h then if(d(r))goto again
...
end L,E,F=false,false,false j={}function ゜(n,e)m,そ=n,e assert(false,n)end function S(n,e,l)return い(n,l)(e or t)end function T(n,e)return S("return "..n,e,true)end function た(t)local l=cocreate(い)::_::local n,e=coresume(l,t)if(n and not e)goto _
if(not n)e,m=m,false
return n,e end function ち(n,e)local t,l=C(n,e)return"line "..l+1 .." col "..t+1end function お(e,l)a,X,m={},false,false L,E,F=false,false,false local t=cocreate(function()S(e)end)local r,n while true do r,n=coresume(t)if(costatus(t)=="dead")break
...
F=false end for n in え()do if n=="•"then X=true else add(j,n)end end if(X)n="computation aborted"break
end if m==nil then if(l)n="unexpected end of code"else n,a=nil
end if(m)n,m=m.."\nat "..ち(e,そ)
J=n j={}end w=function()L=true yield()L=false end t.flip=function(...)local n=pack(flip(...))F=true w()return c(n)end t.coresume=function(n,...)local e=pack(coresume(n,...))while L do yield()e=pack(coresume(n))end m=false return c(e)end t.stat=function(n,...)if n==30then return#j>0or stat(n,...)elseif n==31then if#j>0then return deli(j,1)else local e=stat(n,...)if(e=="•")X=true
return e end else return stat(n,...)end end function つ(n)if(_set_fps)_set_fps(n._update60 and 60or 30)
if(n._init)n._init()
...
flip()F=true w()end E=false end function け(e)if r(e,{"i","interrupt"})then return H elseif r(e,{"f","flip"})then return I elseif r(e,{"r","repl"})then return z elseif r(e,{"mi","max_items"})then return O elseif r(e,{"h","hex"})then return P elseif r(e,{"cl","colors"})then return i elseif r(e,{"c","code"})then local e={[0]=n}for n=1,#u-1do e[n]=u[#u-n]end return e elseif r(e,{"cm","compile"})then return function(n)return た(n)end elseif r(e,{"x","exec"})then return function(n,e)S(n,e)end elseif r(e,{"v","eval"})then return function(n,e)return T(n,e)end elseif r(e,{"p","print"})then return function(n,...)t.print(Z(n),...)end elseif r(e,{"ts","tostr"})then return function(n)return Z(n)end elseif r(e,{"rst","reset"})then run()elseif r(e,{"run"})then つ(t)else assert(false,"unknown \\-command")end end function こ(e)local function t(n)return n and n~=0and true or false end local n if r(e,{"i","interrupt"})then n=function(n)H=t(n)end elseif r(e,{"f","flip"})then n=function(n)I=t(n)end elseif r(e,{"r","repl"})then n=function(n)z=t(n)end elseif r(e,{"mi","max_items"})then n=function(n)O=tonum(n)or-1end elseif r(e,{"h","hex"})then n=function(n)P=t(n)end elseif r(e,{"cl","colors"})then n=function(n)i=n end else assert(false,"unknown \\-command assign")end local e={__newindex=function(t,l,e)n(e)end}return setmetatable(e,e),0end M=stat(4)q,N=0,false poke(24412,10,2)function p(n)if stat(28,n)then if(n~=U)U,q=n,0
return q==0or q>=10and q%2==0elseif U==n then U=nil end end function _update()local t=false local function r(o)local t,e,r=C(d..n,#d+l)if(V)t=V
e+=o if(not(e>=0and e<r))return false
l=max(D(d..n,t,e)-#d,1)V=t v=20return true end local function f(r)local e,o=C(d..n,#d+l)e=r>0and 100or 0l=max(D(d..n,e,o)-#d,1)t=true end local function c(r)u[y]=n y+=r n=u[y]if r<0then l=#n+1else l=max(D(d..n,32,0)-#d,1)local t=e(n,l)if(t~=""and t~="\n")l-=1
...
end elseif i and p(40)then お(n,true)d()elseif r~=""and e>=32and e<154then if(N and e>=128)r=chr(e-63)
...
q+=1う()end function か(n,e)local t,l=coresume(cocreate(e))if not t then printh("error #"..n..": "..l)print("error #"..n.."\npico8 broke something again,\nthis cart may not work.\npress any button to ignore")while(btnp()==0)flip()
cls()end end か(1,function()assert(pack(T"(function (...) return ... end)(1,2,nil,nil)").n==4)end)か(2,function()assert(T"function() local temp, temp2 = {max(1,3)}, -20;return temp[1] + temp2; end"()==-17)end)printh"finished"stop()while true do if(holdframe)holdframe()
