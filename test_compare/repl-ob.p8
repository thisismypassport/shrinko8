...
return t,n+1end function n6(t,n,l,r)if e(t,n)=="["then n+=1local r=n while(e(t,n)=="=")n+=1
...
if(not e";")l","
end return function(e)local t={}for n=1,#r do if n==a then local l,n=r[n](e),pack(d[n](e))for e=1,n.n do t[l+e-1]=n[e]end else t[r[n](e)]=d[n](e)end end return t end end local function nr(o,a)local n,p,t if o then if a then z()n=u()d[n]=f t=nl(n)else n={u()}while(e".")add(n,u())
if(e":")add(n,u())p=true
...
end end z()for n in all(n)do d[n]=f end if(r)d["..."]=f
local e,i,d=v,h,nn v,h,nn={},s+1,f local f=b()for n in all(v)do n()end v,h,nn=e,i,d l"end"q()return function(e)if(a)add(e,{})
local l=nj(e)local i=#l local n=function(...)local t=pack(...)local e=l if#e~=i then local n={}for t=0,i do n[t]=e[t]end e=n end local l={}for e=1,#n do l[n[e]]=t[e]end if(r)l["..."]=pack(unpack(t,#n+1,t.n))
...
l"("return ne(e,r)end end local e=nl(i,d,e,t)if(not e)n-=1
return e end t=function(r)local n,e,t,l=nn()while true do local r,o,i,f=nf(r or 0,n,e)if(not r)break
n,e,t,l=r,o,i,f end return n,t,l end local function nn()local e,n=t()if(not n)i"cannot assign to value"
return n end local function nf()local n=k(nn)l"="local e=k(t)if#n==1and#e==1then return function(t)local n,l=n[1](t)n[l]=e[1](t)end else return function(t)local l,r={},{}for e=1,#n do local n,e=n[e](t)add(l,n)add(r,e)end local e=m(t,e)for n=#n,1,-1do l[n][r[n]]=e[n]end end end end local function nd(e,l)local r=o[n]n+=1local n=sub(r,1,-2)local n=nl(n,0,e,function()return t()end)if(not n)i"invalid compound assignment"
return function(e)local t,l=l(e)t[l]=n(e)end end local function nu()if e"function"then return nr(true,true)else local n=k(u)local e=e"="and k(t)or{}z()for e=1,#n do d[n[e]]=f end if#n==1and#e==1then return function(t)add(t,{[n[1]]=e[1](t)})end else return function(t)local l={}local r=m(t,e)for e=1,#n do l[n[e]]=r[e]end add(t,l)end end end end local function nl(e)local t=no[n-1]x=function()return t~=no[n]end if(not e or x())i(n<=#o and"bad shorthand"or nil)
...
return n,e end local function na()local r=o[n]=="("local t=t()local n if e"do"then n=nn()l"end"else nl(r)n=nn()x=nil end return function(e)while t(e)do if(stat(1)>=1)w()
local n,e=n(e)if(n)return ne(n,e)
end end end local function nl()local r=f local e=nn(true)l"until"local l=t()while(f>r)q()
return function(n)repeat if(stat(1)>=1)w()
local e,t=e(n)if(not e)t=l(n)
while(#n>r)deli(n)
if(e)return ne(e,t)
until t end end local function nc()if o[n+1]=="="then local r=u()l"="local o=t()l","local i=t()local e=e","and t()or g(1)l"do"z()d[r]=f local t=nn()l"end"q()return function(n)for e=o(n),i(n),e(n)do if(stat(1)>=1)w()
add(n,{[r]=e})local e,t=t(n)deli(n)if(e)return ne(e,t)
end end else local r=k(u)l"in"local e=k(t)l"do"z()for n in all(r)do d[n]=f end local o=nn()l"end"q()return function(n)local e=m(n,e)while true do local l={}local t={e[1](e[2],e[3])}if(t[1]==nil)break
e[3]=t[1]for n=1,#r do l[r[n]]=t[n]end if(stat(1)>=1)w()
add(n,l)local e,t=o(n)deli(n)if(e)return ne(e,t)
...
if o[n]==";"or r(o[n],nk)or x and x()then return function()return pack()end else local n,r,l=t()local n={n}while(e",")add(n,(t()))
if#n==1and l and h then return function(n)local n,e=l(n)if(stat(1)>=1)w()
return function()return n(c(e))end end else return function(e)return m(e,n)end end end end local function z(e)local n=u()l"::"if(p[n]and p[n].e==s)i"label already defined"
...
if r=="?"then local e,t=nt"print",k(t)return function(n)e(n)(c(m(n,t)))end end n-=1local r=n local t,f,l=t()if e","or e"="then n=r return nf()elseif n6(o[n])then return nd(t,f)elseif s<=1and j then return function(n)local n=pack(t(n))if(not(l and n.n==0))add(a,n)
n5=n[1]end else if(not l)i"statement has no effect"
return function(n)t(n)end end end b=function(t)p=setmetatable({},{__index=p})p[s]=f s+=1local d=s local i=t and 32767or f local l={}while n<=#o and not r(o[n],nk)and not(x and x())do local n,t=u(l)if(n)add(l,n)
if(t)e";"break
end while(f>i)q()
...
for n in all(v)do n()end return function(n)local n=j and{_ENV=n,_env=n,_=n5}or{_ENV=n}local n=e{[0]=n}if(n)return c(n)
end end n2,nb=10,false local n5={["\0"]="000",["ᵉ"]="014",["ᶠ"]="015"}for n,e in pairs(eu)do if(not f(n,"'\n"))n5[e]=n
end function ee(n)local t=1while t<=#n do local e=e(n,t)local e=n5[e]if(e)n=sub(n,1,t-1).."\\"..e..sub(n,t+1)t+=#e
...
end return true end function nn(e,t)local n=type(e)if n=="nil"then return"nil"elseif n=="boolean"then return e and"true"or"false"elseif n=="number"then return tostr(e,nb)elseif n=="string"then return ee(e)elseif n=="table"and not t then local n="{"local t=0local r=0for e,l in next,e do if(t==n2)n=n..",<...>"break
if(t>0)n=n..","
local l=nn(l,1)if e==r+1then n=n..l r=e elseif et(e)then n=n..e.."="..l else n=n.."["..nn(e,1).."]="..l end t+=1end return n.."}"else return"<"..tostr(n)..">"end end function el(n,e)if(e==nil)return n
if(not n)n=""
...
end end function np(r,o)local t=1local n,l=0,0if(not r)return t,n,l
while t<=#r do local e=e(r,t)local r=e>="█"if(n>=(r and 31or 32))l+=1n=0
if(o)o(t,e,n,l)
if e=="\n"then l+=1n=0else n+=r and 2or 1end t+=1end return t,n,l end function nt(t,l)local n,e=0,0local o,r,t=np(t,function(t,i,r,o)if(l==t)n,e=r,o
end)if(l>=o)n,e=r,t
if(r>0)t+=1
return n,e,t end function nl(l,r,e)local t=1local n=false local r,o,l=np(l,function(o,f,i,l)if(e==l and r==i and not n)t=o n=true
...
flip()no=true w()end nr=false end function nq(e)if r(e,{"i","interrupt"})then return nu elseif r(e,{"f","flip"})then return na elseif r(e,{"r","repl"})then return j elseif r(e,{"mi","max_items"})then return n2 elseif r(e,{"h","hex"})then return nb elseif r(e,{"cl","colors"})then return i elseif r(e,{"c","code"})then local n={[0]=n}for e=1,#u-1do n[e]=u[#u-e]end return n elseif r(e,{"cm","compile"})then return function(n)return ei(n)end elseif r(e,{"x","exec"})then return function(n,e)nx(n,e)end elseif r(e,{"v","eval"})then return function(n,e)return n3(n,e)end elseif r(e,{"p","print"})then return function(n,...)t.print(nn(n),...)end elseif r(e,{"ts","tostr"})then return function(n)return nn(n)end elseif r(e,{"rst","reset"})then run()elseif r(e,{"run"})then ed(t)else assert(false,"unknown \\-command")end end function en(e)local function t(n)return n and n~=0and true or false end local n if r(e,{"i","interrupt"})then n=function(n)nu=t(n)end elseif r(e,{"f","flip"})then n=function(n)na=t(n)end elseif r(e,{"r","repl"})then n=function(n)j=t(n)end elseif r(e,{"mi","max_items"})then n=function(n)n2=tonum(n)or-1end elseif r(e,{"h","hex"})then n=function(n)nb=t(n)end elseif r(e,{"cl","colors"})then n=function(n)i=n end else assert(false,"unknown \\-command assign")end local n={__newindex=function(t,l,e)n(e)end}return setmetatable(n,n),0end nh=stat(4)nf,n0=0,false poke(24412,10,2)function p(n)if stat(28,n)then if(n~=nm)nm,nf=n,0
return nf==0or nf>=10and nf%2==0elseif nm==n then nm=nil end end function _update()local t=false local function r(r)local t,e,o=nt(d..n,#d+l)if(n7)t=n7
e+=r if(not(e>=0and e<o))return false
l=max(nl(d..n,t,e)-#d,1)n7=t v=20return true end local function f(r)local e,o=nt(d..n,#d+l)e=r>0and 100or 0l=max(nl(d..n,e,o)-#d,1)t=true end local function c(r)u[y]=n y+=r n=u[y]if r<0then l=#n+1else l=max(nl(d..n,32,0)-#d,1)local n=e(n,l)if(n~=""and n~="\n")l-=1
...
nf+=1n9()end function n_(n,e)local e,t=coresume(cocreate(e))if not e then printh("error #"..n..": "..t)print("error #"..n.."\npico8 broke something again,\nthis cart may not work.\npress any button to ignore")while(btnp()==0)flip()
