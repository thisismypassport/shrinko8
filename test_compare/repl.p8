...
end end function e(e,n)return sub(e,n,n)end local nm,n7,nx=split"a,b,f,n,r,t,v,\\,\",',\n,*,#,-,|,+,^",split"⁷,⁸,ᶜ,\n,\r,	,ᵇ,\\,\",',\n,¹,²,³,⁴,⁵,⁶",{}for n=1,#nm do nx[nm[n]]=n7[n]end function g(n)return n>="0"and n<="9"end function B(n)return n>="A"and n<="Z"or n>="a"and n<="z"or n=="_"or n>="█"or g(n)end function nd(r,n,i,o)local t=""while n<=#r do local l=e(r,n)if(l==i)break
...
return nil,n end function nn(l,c)local n,s,o,h,b,p,u,i=1,1,{},{},{},{}local function d(n,e)if(c)ne(n,i)
...
end e.n=n return e end local function k(t)local n={}add(n,(t()))while e","do add(n,(t()))end return n end local function X(r,o,i)local n={}if i then add(n,i)elseif not e")"then while true do add(n,(t()))if(e")")break
...
local l=nu(e)local i=#l local n=function(...)local t,e=pack(...),l if(#e~=i)local n={}for t=0,i do n[t]=e[t]end e=n
...
return function(n)t(n)end end end b=function(t)p=setmetatable({},{__index=p})p[s]=f s+=1local d,i,l=s,t and 32767or f,{}while n<=#o and not r(o[n],nt)and not(x and x())do local n,t=u(l)if(n)add(l,n)
if(t)e";"break
end while(f>i)B()
...
end return true end function Z(e,t)local n=type(e)if n=="nil"then return"nil"elseif n=="boolean"then return e and"true"or"false"elseif n=="number"then return tostr(e,P)elseif n=="string"then return n1(e)elseif n=="table"and not t then local n,t,r="{",0,0for e,l in next,e do if(t==O)n=n..",<...>"break
if(t>0)n=n..","
...
return n,e end function np(n,e)local n,e=C(n,e)return"line "..e+1 .." col "..n+1end function ni(e,l)a,X,m={},false,false L,E,F=false,false,false local t,r,n=cocreate(function()S(e)end)while true do r,n=coresume(t)if(costatus(t)=="dead")break
...
F=false end for n in no()do if(n=="•")X=true else add(j,n)
