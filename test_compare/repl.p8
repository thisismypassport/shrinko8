...
if t=="\\"do n+=1local e=b(l,n)t=o[e]if e=="x"do e=tonum("0x"..sub(l,n+1,n+2))if(e)n+=2else r"bad hex escape"
t=chr(e)elseif y(e)do local o=n while y(e)and n<o+3do n+=1e=b(l,n)end n-=1e=tonum(sub(l,o,n))if(not e or e>=256)r"bad decimal escape"
t=chr(e)elseif e=="z"do repeat n+=1e=b(l,n)until not p(e," \r	ᶜᵇ\n")if(e=="")r()
t=""n-=1elseif e==""do r()t=""end if(not t)r("bad escape: "..e)t=""
elseif t=="\n"do r"unterminated string"break end e..=t n+=1end if(n>#l)r("unterminated string",true)
return e,n+1end function Z(e,n,t,l)if b(e,n)=="["do n+=1local l=n while(b(e,n)=="=")n+=1
local l="]"..sub(e,l,n-1).."]"local r=#l if b(e,n)=="["do n+=1if(b(e,n)=="\n")n+=1
...
elseif e=="-"and b(t,n+1)=="-"do n+=2if(b(t,n)=="[")l,n=Z(t,n,i)
if(not l)while(n<=#t and b(t,n)~="\n")n+=1
if(u)d=true else add(r,true)
elseif y(e)or e=="."and y(b(t,n+1))do local f,d="0123456789",true if e=="0"and p(b(t,n+1),"xX")do f..="AaBbCcDdEeFf"n+=2elseif e=="0"and p(b(t,n+1),"bB")do f="01"n+=2end while true do e=b(t,n)if e=="."and d do d=false elseif not p(e,f)do break end n+=1end l=sub(t,o,n-1)if(not tonum(l))i"bad number"l="0"
add(r,tonum(l))elseif D(e)do while D(b(t,n))do n+=1end add(r,sub(t,o,n-1))elseif e=="'"or e=='"'do l,n=nc(t,n+1,e,i)add(r,{t=l})elseif e=="["and p(b(t,n+1),"=[")do l,n=Z(t,n,i,true)add(r,{t=l})else n+=1local l,f,d=unpack(split(sub(t,n,n+2),""))if l==e and f==e and p(e,".>")do n+=2if(d=="="and p(e,">"))n+=1
elseif l==e and f~=e and p(e,"<>")and p(f,"<>")do n+=2if(d=="=")n+=1
elseif l==e and p(e,".:^<>")do n+=1if(f=="="and p(e,".^<>"))n+=1
elseif l=="="and p(e,"+-*/\\%^&|<>=~!")do n+=1elseif p(e,"+-*/\\%^&|<>=~#(){}[];,?@$.:")do else i("bad char: "..e)end add(r,sub(t,o,n-1))end if(not d)add(c,a)add(s,o)add(h,n-1)
...
end local function g()f=setmetatable({},{__index=f})i+=1end local function k()f=getmetatable(f).__index i-=1end local function b(l,t)local e,n={},#t for n=1,n-1do e[n]=t[n](l)end if(n>0)local t=pack(t[n](l))if(t.n~=1)for l=1,t.n do e[n+l-1]=t[l]end n+=t.n-1else e[n]=t[1]
e.n=n return e end local function w(e)local n={}add(n,(e()))while l","do add(n,(e()))end return n end local function y(r,o,i)local n={}if i do add(n,i)elseif not l")"do while true do add(n,(e()))if(l")")break
...
end local function D()local o,u,c,a={},{},1while not l"}"do a=nil local i,f if l"["do i=e()t"]"t"="f=e()elseif r[n+1]=="="do i=p(d())t"="f=e()else i=p(c)f=e()c+=1a=#o+1end add(o,i)add(u,f)if(l"}")break
if(not l";")t","
...
end return t end end local function z(s,h)local n,b,e if s do if h do g()n=d()f[n]=i e=A(n)else n={d()}while(l".")add(n,d())
if(l":")add(n,d())b=true
...
t"("if not l")"do while true do if(l"...")r=true else add(n,d())
if(l")")break
...
add(e,l)local n=i(e)deli(e)if n do if(type(n)=="table")return H(n)
...
end local function C(u,l,a)local i=r[n]n+=1local o,f if a do if(i==".")o=d()return function(n)return l(n)[o]end,true,function(n)return l(n),o end
...
if i==":"do o=d()if(r[n]=="{"or type(r[n])=="table")f=v()return y(l,o,f)
...
return function(e)local t,l=l(e)t[l]=n(e)end end local function E()if(l"function")return z(true,true)else local n,e=w(d),l"="and w(e)or{}g()for e=1,#n do f[n[e]]=i end if(#n==1and#e==1)return function(t)add(t,{[n[1]]=e[1](t)})end else return function(t)local l,r={},b(t,e)for e=1,#n do l[n[e]]=r[e]end add(t,l)end
end local function A(e)local t=B[n-1]h=function()return t~=B[n]end if(not e or h())o(n<=#r and"bad shorthand"or nil)
end local function B()local r,o,e,n=r[n]=="(",e()if l"then"do e,n=c()if l"else"do n=c()t"end"elseif l"elseif"do n=B()else t"end"end else A(r)e=c()if(not h()and l"else")n=c()
h=nil end return function(t)if o(t)do return e(t)elseif n do return n(t)end end end local function v(...)local n=m m=u+1local e=c(...)m=n return e end local function y(n,e)if(n==true)return
...
while(#n>l)deli(n)
if(e)return y(e,t)
until t end end local function j()if r[n+1]=="="do local r=d()t"="local o=e()t","local d,e=e(),l","and e()or p(1)t"do"g()f[r]=i local l=v()t"end"k()return function(n)for e=o(n),d(n),e(n)do if(stat(1)>=1)I()
...
if r[n]==";"or q(r[n],no)or h and h()do return function()return pack()end else local n,r,t=e()local n={n}while(l",")add(n,(e()))
if#n==1and t and a do return function(n)local n,e=t(n)if(stat(1)>=1)I()
...
n-=1local i,e,f,t=n,e()if l","or l"="do n=i return C()elseif Z(r[n])do return D(e,f)elseif u<=1and J do return function(n)local n=pack(e(n))if(not(t and n.n==0))add(G,n)
...
u-=1s=getmetatable(s).__index return function(e)local l,r,t,n=1,#o while l<=r do t,n=o[l](e)if t do if(type(t)~="number")break
if(n.e~=a)break
...
end return true end function f(e,t)local n=type(e)if n=="nil"do return"nil"elseif n=="boolean"do return e and"true"or"false"elseif n=="number"do return tostr(e,T)elseif n=="string"do return n0(e)elseif n=="table"and not t do local n,t,r="{",0,0for e,l in next,e do if(t==S)n=n..",<...>"break
if(t>0)n=n..","
local l=f(l,1)if e==r+1do n=n..l r=e elseif n2(e)do n=n..e.."="..l else n=n.."["..f(e,1).."]="..l end t+=1end return n.."}"else return"<"..tostr(n)..">"end end function nb(n,e)if(e==nil)return n
if(not n)n=""
local t=min(21,#e)for t=1,t do if(#n>0)n..="\n"
local t=e[t]if type(t)=="table"do local e=""for n=1,t.n do if(#e>0)e=e..", "
...
local e=s[5]if n==false do e=s[6]elseif n==true do e=s[7]elseif type(n)~="string"or q(n,{"nil","true","false"})do e=s[8]elseif L[n]do e=s[9]elseif not D(b(n,1))do e=s[10]elseif l[n]do e=s[11]end return e end)end function _draw()local r,o,i=peek(24357),peek2(24360),peek2(24362)camera()local function n(n)cursor(0,127)for n=1,n do rectfill(0,u*6,127,(u+1)*6-1,0)if(u<21)u+=1else print""
end end local function f(n,e)for n=1,n do if(u>e)u-=1
rectfill(0,u*6,127,(u+1)*6-1,0)end end local function d(n,e)for t=0,2do local l=pget(n+t,e+5)pset(n+t,e+5,l==0and s[12]or 0)end end local function l(r)local l=h..a.." "local o,t,e=C(l,#h+c)if e>x do n(e-x)elseif e<x do f(x-e,e)end x=e _=mid(_,0,max(x-21,0))::n::local n=u-x+_ if(n+t<0)_+=1goto n
if(n+t>=21)_-=1goto n
...
if(n=="\r"or n=="\n")m+=e return true
end end end::n::local t,e if G or g do t,e=E(g,0,m)if(e-m<=20and G)g,G=nb(g,G)t,e=E(g,0,m)if(#G==0and not v)G=nil
end if(not v)camera()
if(m==0and not v)l(not g)
if g do local r,t=sub(g,t),min(e-m,20)n(t)V(r,0,(u-t)*6,s[1])if t<e-m do if(f(t))goto n
...
if M and not d do v="running, press 'esc' to abort"_draw()flip()v=nil else if(N and not d and not F)flip()
if(not N and holdframe)holdframe()
F=false end for n in nd()do if(n=="•")X=true else add(j,n)
end if(X)n="computation aborted"break
end if(i==nil)if(l)n="unexpected end of code"else n,G=nil
if(i)n,i=i.."\nat "..n3(e,nw)
O=n j={}end I=function()r=true yield()r=false end e.flip=function(...)local n=pack(flip(...))F=true I()return H(n)end e.coresume=function(n,...)local e=pack(coresume(n,...))while r do yield()e=pack(coresume(n))end i=false return H(e)end e.stat=function(n,...)if n==30do return#j>0or stat(n,...)elseif n==31do if#j>0do return deli(j,1)else local n=stat(n,...)if(n=="•")X=true
...
if n._update60 do n._update60()elseif n._update do n._update()end if(n._draw)n._draw()
flip()F=true I()end d=false end function ns(n)if q(n,{"i","interrupt"})do return M elseif q(n,{"f","flip"})do return N elseif q(n,{"r","repl"})do return J elseif q(n,{"mi","max_items"})do return S elseif q(n,{"h","hex"})do return T elseif q(n,{"cl","colors"})do return s elseif q(n,{"c","code"})do local n={[0]=a}for e=1,#w-1do n[e]=w[#w-e]end return n elseif q(n,{"cm","compile"})do return function(n)return nx(n)end elseif q(n,{"x","exec"})do return function(n,e)W(n,e)end elseif q(n,{"v","eval"})do return function(n,e)return Y(n,e)end elseif q(n,{"p","print"})do return function(n,...)e.print(f(n),...)end elseif q(n,{"ts","tostr"})do return function(n)return f(n)end elseif q(n,{"rst","reset"})do run()elseif q(n,{"run"})do nm(e)else assert(false,"unknown \\-command")end end function nh(e)local function t(n)return n and n~=0and true or false end local n if q(e,{"i","interrupt"})do n=function(n)M=t(n)end elseif q(e,{"f","flip"})do n=function(n)N=t(n)end elseif q(e,{"r","repl"})do n=function(n)J=t(n)end elseif q(e,{"mi","max_items"})do n=function(n)S=tonum(n)or-1end elseif q(e,{"h","hex"})do n=function(n)T=t(n)end elseif q(e,{"cl","colors"})do n=function(n)s=n end else assert(false,"unknown \\-command assign")end local n={__newindex=function(t,l,e)n(e)end}return setmetatable(n,n),0end Q=stat(4)K,R=0,false poke(24412,10,2)function k(n)if stat(28,n)do if(n~=nn)nn,K=n,0
return K==0or K>=10and K%2==0elseif nn==n do nn=nil end end function _update()local e=false local function t(t)local e,n,l=C(h..a,#h+c)if(ne)e=ne
n+=t if(not(n>=0and n<l))return false
c=max(E(h..a,e,n)-#h,1)ne=e A=20return true end local function o(t)local n,l=C(h..a,#h+c)n=t>0and 100or 0c=max(E(h..a,n,l)-#h,1)e=true end local function f(n)w[z]=a z+=n a=w[z]if(n<0)c=#a+1else c=max(E(h..a,32,0)-#h,1)local n=b(a,c)if(n~=""and n~="\n")c-=1
e=true end local function i()if#a>0do if(#w>50)del(w,w[1])
w[#w]=a add(w,"")z=#w e=true end end local function d(n)if(c+n>0)a=sub(a,1,c+n-1)..sub(a,c+n+1)c+=n e=true
end local function l(n)a=sub(a,1,c-1)..n..sub(a,c)c+=#n e=true end local r,u,n=stat(28,224)or stat(28,228),stat(28,225)or stat(28,229),-1if k(80)do if(c>1)c-=1e=true
elseif k(79)do if(c<=#a)c+=1e=true
elseif k(82)do if((r or not t(-1))and z>1)f(-1)
elseif k(81)do if((r or not t(1))and z<#w)f(1)
else local t=stat(31)n=ord(t)if t=="•"do if(#a==0)extcmd"pause"else G,O={}i()
elseif t=="\r"or t=="\n"do if(u)l"\n"else nu(a)if(not G)l"\n"else i()
elseif r and k(40)do nu(a,true)i()elseif t~=""and n>=32and n<154do if(R and n>=128)t=chr(n-63)
l(t)elseif n==193do l"\n"elseif n==192do o(-1)elseif n==196do o(1)elseif n==203do R=not R B,P="shift now selects "..(R and"punycase"or"symbols"),40elseif k(74)do if(r)c=1e=true else o(-1)
elseif k(77)do if(r)c=#a+1e=true else o(1)
elseif k(42)do d(-1)elseif k(76)do d(0)end end local t=stat(4)if(t~=Q or n==213)l(t)Q=t
if n==194or n==215do if a~=""and a~=Q do Q=a printh(a,"@clip")if(n==215)a=""c=1
...
if(e)A,ne=20
K+=1nf()end function na(n,e)local e,t=coresume(cocreate(e))if not e do printh("error #"..n..": "..t)print("error #"..n.."\npico8 broke something again,\nthis cart may not work.\npress any button to ignore")while(btnp()==0)flip()
