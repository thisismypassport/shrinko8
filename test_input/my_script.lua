...
function module.preprocess_main(opts)
    ...
    local argtable = python.table(argopts)
    assert(argtable[1] == "my-script-arg" and argtable[2] == "--my-script-opt" and argtable[3] == "123")
...
function module.postprocess_main(opts)
    ...
    fh:write(shrinko.to_utf8(cart.code)) -- to_utf8
    fh:close()
    ...
    assert(shrinko.from_utf8(shrinko.to_utf8(test_p8str)) == test_p8str)
